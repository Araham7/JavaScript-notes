...
/* ------------------- (4). " Array.isArray() " ------------------ */
// Array.isArray() ==> Ye hame batlayega ki given(coming) data array hai ya nahi agar given data array hai to "true" print karega , aur agar given data array nahi hai to ye "false" print karega .S
...
/* ------------------- (5). " Array.isArray() " ===> Ye input me string leta hai aur output me array deta hai . ------------------ */
